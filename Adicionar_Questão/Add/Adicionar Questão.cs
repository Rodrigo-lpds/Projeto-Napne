...
namespace Add
{
    public partial class Add_Q : Form
    {
        ...
        public void AdicionarTópico(string Tópico) 
        {
            comboBox3.Items.Add(Tópico);
        }
        private void Add_Q_Load(object sender, EventArgs e)
        {
            ...
            BD.execute("select disciplina from disciplina");
            try
            {
                while (BD.leitor.Read())
                {
                    comboBox1.Items.Add(BD.leitor.GetString(0));
        ...
        private void comboBox3_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            if (comboBox3.SelectedItem.ToString() == "Adicionar Tópico") 
            {
                if (comboBox1.SelectedItem.ToString() == "Matemática" || comboBox1.SelectedItem.ToString() == "Física" || comboBox1.SelectedItem.ToString() == "Química")
                {
                    verif = true;
                    disciplina = comboBox1.SelectedItem.ToString();
                   
                    
                    Adicionar_Tópicos abrir = new Adicionar_Tópicos();
                    abrir.ShowDialog();
                ...
                else
                {
                    ...
                    Adicionar_Tópicos abrir = new Adicionar_Tópicos(); //dis = disciplina
                    abrir.ShowDialog();
                   
                }

            }
            Adicionar_Tópicos x = new Adicionar_Tópicos();

            comboBox1.Text = x.var;
        ...
        private void Add_Q_FormClosed(object sender, FormClosedEventArgs e)
        {
            Application.Exit();
        }
