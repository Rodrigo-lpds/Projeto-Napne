...
namespace Estágio
{
    public partial class quimica_DV3 : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            quimica_DV2 es = new quimica_DV2();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            quimica_DV4 es = new quimica_DV4();
            es.ShowDialog(); // Substituindo o Show()
        ...
        private void quimica_DV3_Load(object sender, EventArgs e)
        {
